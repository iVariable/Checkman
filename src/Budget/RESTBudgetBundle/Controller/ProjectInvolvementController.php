...
class ProjectInvolvementController extends \Budget\RESTBudgetBundle\Controller\Helper\RESTController
{
    ...
    public function postInvolvementsAction()
    {
        ...
        $editForm = $this->createForm(new \Budget\BudgetBundle\Form\ProjectInvolvementType(), $entity, array('method' => "POST"));
    ...
    public function putInvolvementAction($id)
    {
        ...
        $editForm = $this->createForm(new \Budget\BudgetBundle\Form\ProjectInvolvementType(), $entity, array('method' => "PUT"));
        $editForm->handleRequest($this->getRequest());
