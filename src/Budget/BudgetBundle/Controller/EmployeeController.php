...
use Budget\BudgetBundle\Form\EmployeeType;
...
class EmployeeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BudgetBundle:Employee')->findAll();
     ...
     * @Method("POST")
     * @Template("BudgetBundle:Employee:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BudgetBundle:Employee')->find($id);
     ...
     * @Method("PUT")
     * @Template("BudgetBundle:Employee:edit.html.twig")
     */
