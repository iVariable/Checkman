...
use Budget\BudgetBundle\Entity\SpendingsType;
use Budget\BudgetBundle\Form\SpendingsTypeType;
...
class SpendingsTypeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BudgetBundle:SpendingsType')->findAll();
     ...
     * @Method("POST")
     * @Template("BudgetBundle:SpendingsType:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BudgetBundle:SpendingsType')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BudgetBundle:SpendingsType:edit.html.twig")
     */
