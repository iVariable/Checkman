...
use Budget\BudgetBundle\Entity\Occupation;
use Budget\BudgetBundle\Form\OccupationType;
...
class OccupationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BudgetBundle:Occupation')->findAll();
     ...
     * @Method("POST")
     * @Template("BudgetBundle:Occupation:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BudgetBundle:Occupation')->find($id);
     ...
     * @Method("PUT")
     * @Template("BudgetBundle:Occupation:edit.html.twig")
     */
