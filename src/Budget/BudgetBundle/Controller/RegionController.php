...
use Budget\BudgetBundle\Form\RegionType;
...
class RegionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BudgetBundle:Region')->findAll();
     ...
     * @Method("POST")
     * @Template("BudgetBundle:Region:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BudgetBundle:Region')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BudgetBundle:Region:edit.html.twig")
     */
