...
use Budget\BudgetBundle\Form\SpendingsType;
...
class SpendingsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BudgetBundle:Spendings')->findAll();
     ...
     * @Method("POST")
     * @Template("BudgetBundle:Spendings:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BudgetBundle:Spendings')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BudgetBundle:Spendings:edit.html.twig")
     */
