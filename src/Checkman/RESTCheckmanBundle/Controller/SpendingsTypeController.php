...
class SpendingsTypeController extends \Checkman\RESTCheckmanBundle\Controller\Helper\RESTController
{
    ...
    public function getSpendingstypesAction()
    {
        ...
        /**@var $type \Checkman\CheckmanBundle\Entity\SpendingsType*/
    ...
    public function postSpendingstypesAction()
    {
        ...
        $editForm = $this->createForm(new \Checkman\CheckmanBundle\Form\SpendingsTypeType(), $entity, array('method' => "POST"));
    ...
    public function putSpendingstypeAction($id)
    {
        ...
        $editForm = $this->createForm(new \Checkman\CheckmanBundle\Form\SpendingsTypeType(), $entity, array('method' => "PUT"));
        $editForm->handleRequest($this->getRequest());
