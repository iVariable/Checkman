...
class SpendingsController extends \Checkman\RESTCheckmanBundle\Controller\Helper\RESTController
{
    ...
    public function postSpendingsAction()
    {
        ...
        $editForm = $this->createForm(
            new \Checkman\CheckmanBundle\Form\SpendingsType(),
            $entity,
            array('method' => "POST")
        );
    ...
    public function putSpendingAction($id)
    {
        ...
        $editForm = $this->createForm(new \Checkman\CheckmanBundle\Form\SpendingsType(), $entity, array('method' => "PUT"));
        $editForm->handleRequest($this->getRequest());
