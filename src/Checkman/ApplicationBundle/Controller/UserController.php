...
use Checkman\ApplicationBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ApplicationBundle:User')->findAll();
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ApplicationBundle:User')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="crud_user_update")
     * @Method("PUT")
     ...
     *
     * @Route("/{id}", name="crud_user_delete")
     * @Method("DELETE")
     */
