define(
    ...
    function(
        ...
        var router = Bicycle.Core.Router.extend({
            ...
            collection: function(){
                return this.app().collection('spendingstypes');
            },
            ...
            routes : {
                "admin/spendingstype" : "route_list"
                ,"admin/spendingstype/new": 'route_new'
                ,"admin/spendingstype/:id/edit": 'route_edit'
                ,"admin/spendingstype/:id": 'route_show'
            },
