define(
    ...
    function(
        ...
        var router = Bicycle.Core.Router.extend({
            ...
            collection: function(){
                return this.app().collection('employees');
            },
            ...
            routes : {
                "admin/employees" : "route_list"
                ,"admin/employees/new": 'route_new'
                ,"admin/employees/:id/edit": 'route_edit'
                ,"admin/employees/:id": 'route_show'
            },
